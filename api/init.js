...
router.post('/', async (req, res) => {
    try {
        const { domain, transaction_id, bpp_id, bpp_uri, provider_id, items, billing, fulfillment, payment } = req.body;

        const context = build({ domain, action: 'init', transactionId: transaction_id });
